...
import { ObservablesModule } from './app/observables/observables.module';

if (environment.production) {
  enableProdMode();
}

platformBrowserDynamic().bootstrapModule(ObservablesModule)
  .then(() => console.log('Observables Concepts Module app is bootstrap first'))
